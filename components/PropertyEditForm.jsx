...
const PropertyEditForm = () => {
  ...
  const [mounte, setMounte] = useState(true);
    ...
    const fetchPropertyData = async () => {
      try {
        ...
        if (propertyData && propertyData.rates) {
          const defualtRates = { ...propertyData.rates };
          for (const rate of Object.keys(defualtRates)) {
            if (defualtRates[rate] === null) {
              defualtRates[rate] = "";
            }
          }
          propertyData.rates = defualtRates;
        }
